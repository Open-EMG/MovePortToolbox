...
for i=1:25 % subjects 1 to 25
    ...
    for j=1:length(postures)
        ...
        for k=1:size(segment_name,1)
            ...
            label_sample=idx_posture*ones(size(feature_emg_sample,1),1);
...
%     save([path,'/results/accuracy_emg_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_emg');
%     save([path,'/results/accuracy_ips_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_ips');
%     save([path,'/results/accuracy_imu_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_imu');
%     save([path,'/results/accuracy_mocap_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_mocap');
%     save([path,'/results/accuracy_emg_ips_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_emg_ips');
%     save([path,'/results/accuracy_emg_imu_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_emg_imu');
%     save([path,'/results/accuracy_emg_mocap_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_emg_mocap');
%     save([path,'/results/accuracy_mocap_ips_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_mocap_ips');
%     save([path,'/results/accuracy_mocap_imu_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_mocap_imu');
%     save([path,'/results/accuracy_ips_imu_posture_',num2str(n_class),'_class_','cnn.mat'],'acc_ips_imu');
