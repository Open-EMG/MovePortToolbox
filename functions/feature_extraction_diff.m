function feature=feature_extraction_diff(data,window_length,window_step,fs)
...
for i=1:dim3
    ...
    for idx_feature=1:size(feature_tmp,2)
        feature_tmp_diff=diff(feature_tmp(:,idx_feature));
        feature_tmp_diff=[feature_tmp_diff(1);feature_tmp_diff];
        feature_diff(:,idx_feature)=feature_tmp_diff;
    end
    feature(:,:,i)=feature_diff;
end
