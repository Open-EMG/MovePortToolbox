function feature=feature_extraction_emg(data,window_length,window_step,fs)
...
for i=1:dim3
    ...
    for idx_sample=1:window_step_sample:dim2-window_length_sample+1
        ...
        for j=1:dim1
            ...
            wl=my_wl(data_seg);
            zc=my_zc(data_seg,0);
            ssc=my_ssc(data_seg,0);
            feature_channel_window=[feature_channel_window;[rms,wl,zc,ssc]];
        end
