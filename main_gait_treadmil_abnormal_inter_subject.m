...
%     save([path,'/results/f1_emg_2_',mode_type,'_',model,'_tolRate_',num2str(tolerance_rate*100),'_Q_',num2str(Q),'_inter_subject.mat'],'f1_emg_2');
%     save([path,'/results/f1_imu_2_',mode_type,'_',model,'_tolRate_',num2str(tolerance_rate*100),'_Q_',num2str(Q),'_inter_subject.mat'],'f1_imu_2');
%     save([path,'/results/f1_mocap_2_',mode_type,'_',model,'_tolRate_',num2str(tolerance_rate*100),'_Q_',num2str(Q),'_inter_subject.mat'],'f1_mocap_2');
%     save([path,'/results/f1_emg_mocap_2_',mode_type,'_',model,'_tolRate_',num2str(tolerance_rate*100),'_Q_',num2str(Q),'_inter_subject.mat'],'f1_emg_mocap_2');
%     save([path,'/results/f1_emg_imu_2_',mode_type,'_',model,'_tolRate_',num2str(tolerance_rate*100),'_Q_',num2str(Q),'_inter_subject.mat'],'f1_emg_imu_2');
%     save([path,'/results/f1_mocap_imu_2_',mode_type,'_',model,'_tolRate_',num2str(tolerance_rate*100),'_Q_',num2str(Q),'_inter_subject.mat'],'f1_mocap_imu_2');
%     save([path,'/results/f1_emg_mocap_imu_2_',mode_type,'_',model,'_tolRate_',num2str(tolerance_rate*100),'_Q_',num2str(Q),'_inter_subject.mat'],'f1_emg_mocap_imu_2');
